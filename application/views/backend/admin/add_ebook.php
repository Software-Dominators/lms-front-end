    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form" action="<?php echo site_url('addons/ebook_manager/ebook/add'); ?>"
                                    ...
                                    <div class="tab-pane mt-4 bg-dager" id="basic">
                                        <div class="row justify-content-center">
                                            <div class="col-md-10">
                                                ...
                                                <h4 class='mb-3'><?php echo get_phrase('add_a_new_ebook'); ?>
                                                </h4>
                                                    ...
                                                    <div class="wrapper-image-preview" style="margin-left: -6px;">
                                                        <div class="box" style="width: 300px;">
                                                            <div class="js--image-preview"
                                                                style="background-image: url('<?php echo base_url('uploads/ebook/banner/placeholder.png') ?>'); background-color: #F5F5F5; background-size: cover; background-position: center;">
                                                            </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="wrapper-image-preview" style="margin-left: -6px;">
                                                        <div class="box" style="width: 300px;">
                                                            <div class="js--image-preview"
                                                                style="background-image: url('<?php echo base_url('uploads/ebook/thumbnails/placeholder.png') ?>'); background-color: #F5F5F5; background-size: cover; background-position: center;">
                                                            </div>
                                                            <div class="upload-options">
